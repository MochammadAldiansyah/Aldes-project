    ...
    <div class="auth-container">
        ...
        <div class="auth-panel-left">
            ...
            <div class="content">
                ...
                <p>Kelola produktivitas Anda dengan aplikasi kami.</p>

                <div class="features">
                    <div class="feature-item">
                        <img class="feature-icon" src="{{ asset('assets/img/petir.png.png') }}" alt="petir">
                        <span class="feature-text">Performa super cepat</span>
                    </div>
                    <div class="feature-item">
                       <img class="feature-icon" src="{{ asset('assets/img/gembok.png') }}" alt="">
                        <span class="feature-text">Keamanan data terjamin</span>
                    </div>
                    <div class="feature-item">
                      <img class="feature-icon" src="{{ asset('assets/img/awan.png') }}" alt="">
